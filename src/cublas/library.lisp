...
(defmacro defun/cublas_v2* ((cname lisp-name &key downcase? real-only? complex-only? add-half?) &body args)
...
(defun/cublas_v2* ("cublas?gemmBathed" ?gemm-bathed :add-half? t)
  (handle handle)
  (transa operation)
  (transb operation)
  (m :int)
